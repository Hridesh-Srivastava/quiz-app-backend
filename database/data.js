export default [
  ...
  },
  {
    ...
    options: ["Replace values of dict1 with values from dict2 for matching keys", "Remove keys that are not in dict2", "Convert dict1 to a list", "Merge dictionaries without modifying dict1"],
  },
  {
    id: 16,
