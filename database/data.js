export default [
  ...
  },
  {
    ...
    options: ["Match keys and replace dict1 values with dict2 values", "Remove keys that are not in dict2", "Convert dict1 to a list", "Merge dictionaries without modifying dict1"],
  },
  {
    id: 16,
